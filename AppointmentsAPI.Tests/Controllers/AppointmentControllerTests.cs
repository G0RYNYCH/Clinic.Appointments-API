...
public class AppointmentControllerTests
{
    ...
    public AppointmentControllerTests()
    {
        ...
        mockHttpContext.RequestAborted = _cancellationToken;
    ...
    public async Task GetAppointments_ValidModel_ReturnsResult()
    {
        ...
        _appointmentService.Setup(x => x.SearchAsync(searchDto, _cancellationToken))
    ...
    public async Task GetById_ExistingId_ReturnsAppointment()
    {
        ...
        _appointmentService.Setup(x => x.GetByIdAsync(appointmentId, _cancellationToken))
            .ReturnsAsync(searchResult);
    ...
    public async Task Create_AppointmentDto_Success()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        _appointmentService.Verify(x => x.CreateAsync(appointmentDto, _cancellationToken), Times.Once());
    ...
    public async Task Update_ExistingId_Succeess()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        _appointmentService.Verify(x => x.UpdateAsync(appointmentId, updateAppointmentDto, _cancellationToken), Times.Once());
    ...
    public async Task Update_IsNotExistingId_ReturnsBadRequest()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        _appointmentService.Verify(x => x.UpdateAsync(appointmentId, updateAppointmentDto, _cancellationToken), Times.Never());
        _logger.VerifyLogging("Update method is called", LogLevel.Information, Times.Once());
        _logger.VerifyLogging($"Appointment with Id = {appointmentId} is null", LogLevel.Information, Times.Once());
    ...
    public async Task Delete_ExistingId_Succeess()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        _appointmentService.Verify(x => x.DeleteAsync(appointmentId, _cancellationToken), Times.Once());
    ...
    public async Task Delete_IsNotExistingId_ReturnsBadRequest()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        _appointmentService.Verify(x => x.DeleteAsync(appointmentId, _cancellationToken), Times.Never());
        _logger.VerifyLogging("Delete method is called", LogLevel.Information, Times.Once());
        _logger.VerifyLogging($"Appointment with Id = {appointmentId} is null", LogLevel.Information, Times.Once());
